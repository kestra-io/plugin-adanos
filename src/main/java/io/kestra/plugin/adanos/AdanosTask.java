    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.adanos.AdanosTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class AdanosTask extends Task implements RunnableTask<AdanosTask.Output> {
    @Schema(
    ...
    @Override
    public AdanosTask.Output run(RunContext runContext) throws Exception {
